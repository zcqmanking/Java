	...
	private boolean bGetCurUserInfo(DBManager dbMgr,
		...
		try {
			...
			if (lastActiveRs.next()) {
				...
				share.setLongitude(lastActiveRs.getString("Longitude"));
				share.setLatitude(lastActiveRs.getString("Latitude"));
				share.setTitle(lastActiveRs.getString("Title"));
	...
	private boolean bGetHotShare(DBManager dbMgr, HttpServletRequest request,
		...
		try {
			while (rsHot.next()) {
				...
				s.setTitle(rsHot.getString("Title"));
	...
	private boolean bGetFavShare(DBManager dbMgr, HttpServletRequest request,
		...
		try {
			while (rsFav.next()) {
				...
				s.setTitle(rsFav.getString("Title"));
